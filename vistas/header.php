...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>SIS</b> I</span>
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
        ...
        <li><a href="#"><i class="fa fa-question-circle"></i> <span>Ayuda</span><small class="label pull-right bg-green">PDF</small></a></li>
        <li><a href="#"><i class="fa  fa-exclamation-circle"></i> <span>Ayuda</span><small class="label pull-right bg-green">IT</small></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>